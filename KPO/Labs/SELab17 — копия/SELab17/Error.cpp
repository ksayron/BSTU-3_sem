...
namespace Error {
    ERROR errors[ERROR_MAX_ENTRY]{
        ...
        ERROR_ENTRY(604,"Îøèáêà â ïàğàìòåğàõ âûçûâàåìîé ôóíêöèè"),
        ERROR_ENTRY_NODEF(605),ERROR_ENTRY_NODEF(606),ERROR_ENTRY_NODEF(607),ERROR_ENTRY_NODEF(608),ERROR_ENTRY_NODEF(609),
        ERROR_ENTRY_NODEF(610),ERROR_ENTRY_NODEF(620),ERROR_ENTRY_NODEF(630),ERROR_ENTRY_NODEF(640),
        ERROR_ENTRY_NODEF(650),ERROR_ENTRY_NODEF(660),ERROR_ENTRY_NODEF(670),ERROR_ENTRY_NODEF(680),
        ERROR_ENTRY_NODEF(690),
