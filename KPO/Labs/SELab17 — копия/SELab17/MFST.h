...
//вывод шага, ПРАВИЛ перехода, текущего содержимого входной ленты и стека
...
//вывод сообщения без увеличения шага (об ошибке в результате трассировки)
#define MFST_TRACE4(c)		std::cout<<std::setw(4)<<std::left << ++FST_TRACE_n << ": "<<std::setw(20)<< std::left <<c<<std::endl;
//вывод сообщения с увеличением шага (о восстановлении состояния)
